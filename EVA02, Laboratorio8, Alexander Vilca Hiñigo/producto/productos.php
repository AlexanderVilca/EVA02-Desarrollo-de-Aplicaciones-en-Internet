    ...
    <div class="container">
        <div class="card mt-5 text-center">
            ...
            <div class="card-body">
                ...
                <a href="agregar.html"><button type="button" class="btn btn-info">Agregar Producto</button></a>
                <a href="eliminar.html"><button type="button" class="btn btn-info">Eliminar Producto</button></a>
                <a href="actualizar.html"><button type="button" class="btn btn-info">Actualizar Producto</button></a>
            </div>
        </div>
    </div>
